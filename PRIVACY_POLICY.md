...
- A first-launch date used solely to compute your 14-day Tempo+ trial window.
...
Tempo's one-time purchase ($9.99) and Tempo+ subscription ($4.99/month or $39.99/year) are processed by Apple's App Store. We never see your payment information. Apple shares aggregated, anonymised statistics with us about purchases, refunds, and subscription churn. We use these to understand the business; we don't combine them with anything personal.
